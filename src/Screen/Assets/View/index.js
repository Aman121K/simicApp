...
console.log("Vikas Params..",data)
  // let itemId = route.params.params.itemId;
  // const data=route.params.data;
  // console.log("View Data is.../",itemId)
          ...
          <View style={[ styles.container ]}>
            <View style={{ marginTop: 20 }}>
              ...
              <View style={{  flexDirection: 'row', justifyContent: 'space-between', alignItems:'center' }}>
                ...
                <Text style={[ styles.regularFont, { fontSize: 14 }]}>{data?.item_name}</Text>
              </View>
              <View style={{  flexDirection: 'row', justifyContent: 'space-between', alignItems:'center' }}>
                <Title style={[ styles.regularFont, { fontSize: 14 }]}>Descrizione: </Title>
                <Text style={[ styles.regularFont, { fontSize: 14 }]}>{data?.description}</Text>
              </View>
              <View style={{  flexDirection: 'row', justifyContent: 'space-between', alignItems:'center' }}>
              ...
              <View style={{  flexDirection: 'row', justifyContent: 'space-between', alignItems:'center', flexWrap: 'wrap' }}>
                ...
                <Text style={[ styles.regularFont, { fontSize: 14 }]}>{ data?.location_name }</Text>
              </View>
              <View style={{  flexDirection: 'row', justifyContent: 'space-between', alignItems:'center', marginTop: 10 }}>
                { itemDetails.item_image_url !='' ? <Image source={{uri:data?.item_image_url}} style={{width: 150, height: 150, borderRadius: 10, marginRight: 20 }}/> : <Image source={ require('../../../assets/images/empty.png') } style={{width: 150, height: 150, borderRadius: 10, marginRight: 20 }}/> }
              </View>
